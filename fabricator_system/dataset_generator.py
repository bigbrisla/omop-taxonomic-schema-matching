...
try:
    from minio import Minio  # optional: only needed for the original MinIO output path
except ImportError:  # pragma: no cover - local filesystem runs don't need MinIO
    Minio = None
